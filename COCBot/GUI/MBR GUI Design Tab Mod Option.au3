...
Local $x = 20, $y = 177
	$grpMultyFarming = GUICtrlCreateGroup( "Multy-Farming With Smart Switch", $x - 20, $y - 20, 438, 80)
		...
		$chkMultyWithBoost = GUICtrlCreateCheckbox("With Boosted Barrack", $x - 10, $y + 33, -1, -1)
			$txtTip = "Will running MultyFarming Mode With Boosted Barrack"
			_GUICtrlSetTip(-1, $txtTip)
			GUICtrlSetOnEvent(-1, "MultiFarming")
		GUICtrlCreateGroup("", -99, -99, 1, 1)
