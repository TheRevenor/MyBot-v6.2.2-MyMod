...
$hGUI_NOTIFY_TAB_ITEM1 = GUICtrlCreateTabItem(GetTranslated(600,18,"PushBullet/Telegram"))
	...
	Local $x = 25, $y = 45
		...
		_GUICtrlSetTip(-1, "Send an Alert when at least one builder is idle.")
		GUICtrlSetState(-1, $GUI_DISABLE)
		$y += 20
		...
		$chkAlertPBOtherDevice = GUICtrlCreateCheckbox(GetTranslated(619, 37, "Another device"), $x + 210, $y, -1, -1)
			...
			GUICtrlSetState(-1, $GUI_DISABLE)
		$chkAlertTopGain = GUICtrlCreateCheckbox("Top Gain Loot", $x + 315, $y, -1, -1)
	...
	Local $x = 25, $y = 45
		$lblgrppushbullet = GUICtrlCreateGroup(GetTranslated(620, 0, "Remote Control Functions"), $x - 20, $y - 20, 430, 334)
			...
			$lblPBdesc = GUICtrlCreateLabel(GetTranslated(620, 1, "BOT") & " " & GetTranslated(620, 14,"HELP") & GetTranslated(620,2, " - send this help message") & @CRLF & _
				...
				GetTranslated(18, 111, "GETCHATS <STOP|NOW|INTERVAL> - to get the latest clan chat as an image"), $x, $y - 5, -1, -1, $SS_LEFT)
			$y = 240
